...
const Events = {
  Page: {
    ...
    //重命名Page时，该PageName已经存在
    ReNameAlready: 'reNameAlready',
    //创建Page时，指定的Browser为null;
    AttachBrowser: 'attachBrowser',
    //自主销毁browser
    AutonomousCloseBrowser: 'autonomousCloseBrowser',
    //自主销毁page
    AutonomousPage: 'autonomousPage',
    PageListener: 'pageListener',
    PageErrorClose: 'pageErrorClose',
  },
  ...
  Browser: {
    ...
    AutonomousClose: 'autonomousClose',
    ChromiumError: 'chromiumError',
